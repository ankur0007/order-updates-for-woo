...
final class GetAnalyticsProductsEndpoint implements Registrable {
	...
	private const ROUTE = '/analytics/products';
	...
	public function handle( WP_REST_Request $request ): WP_REST_Response|WP_Error {
		...
		$response = array( 'products' => $this->analytics_lookup_db->by_product( $from, $to ) );

		return rest_ensure_response( apply_filters( 'order_updates_for_woo_analytics_products_response', $response, $request ) );
	}
}
