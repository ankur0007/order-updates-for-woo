...
final class Constants {
	...
	public const STATUS_SEED_DEFAULTS = array(
		array( 'key' => 'neutral', 'label' => 'Neutral', 'color' => '#6b7280' ),
		array( 'key' => 'notice',  'label' => 'Notice',  'color' => '#2271b1' ),
		array( 'key' => 'warning', 'label' => 'Warning', 'color' => '#d97706' ),
		array( 'key' => 'urgent',  'label' => 'Urgent',  'color' => '#dc2626' ),
		array( 'key' => 'success', 'label' => 'Success', 'color' => '#16a34a' ),
	);
