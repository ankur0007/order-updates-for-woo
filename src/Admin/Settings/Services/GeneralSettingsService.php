	...
	public function get_settings(): array {
		$fields = array(
			...
			array(
				...
				'desc'    => __( 'Let admins assign updates to team members.', 'order-updates-for-woo' ),
			...
			array(
				...
				'desc'    => __( 'Allow admins to assign a highlight color to each update.', 'order-updates-for-woo' ),
			...
			array(
				...
				'desc'    => __( 'Allow a plain text internal note for team context.', 'order-updates-for-woo' ),
			...
			array(
				...
				'desc'    => __( 'Allow a separate plain text customer-facing note.', 'order-updates-for-woo' ),
			...
			array(
				...
				'desc'    => __( 'Allow updates to be marked as solved.', 'order-updates-for-woo' ),
