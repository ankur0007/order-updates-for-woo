...
final class NotificationsPageController {
	...
	private static function label_for_type( string $type ): string {
		return match ( $type ) {
			...
			'status_changed'   => __( 'Status changed', 'order-updates-for-woo' ),
			'title_changed'    => __( 'Title changed', 'order-updates-for-woo' ),
			'solved'           => __( 'Marked solved', 'order-updates-for-woo' ),
			'reopened'         => __( 'Reopened', 'order-updates-for-woo' ),
	...
	private static function icon_for_type( string $type ): string {
		return match ( $type ) {
			...
			'status_changed'    => 'dashicons-tag',
			'title_changed'     => 'dashicons-edit',
			'solved'            => 'dashicons-yes-alt',
